...
- What are the benefits of randomized experiments? When might we want to
...
- What are we trying to learn about from a randomized experiment? (Typically.)
  ...
  learn about unobserved counterfactual quantities? (What is a counterfactual
  quantity and why might we care about this?)
 - How can we randomize using R? How can we use R to test hypotheses about
...
## Overly Ambitious Plan
 ...
 - Jake introduces concepts:  potential outcomes, treatment effects, unbiased
