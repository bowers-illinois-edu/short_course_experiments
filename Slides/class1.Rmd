...
- It's not wrong to _conceptualize_ "cause" in another way (for example,
  ...
  counterfactual framework has make discussion of the design and analysis of
  experiments easier [@brady2008causation].

- For example, we can have mechanistic explanation linking fertilizer to corn
  growth but also a covering law theory. The counterfactual idea helps us
  relate specific implications to specific observations.
